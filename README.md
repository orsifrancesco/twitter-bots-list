...
Bot | Description | Status |
|---|---|---|
| [5hmCpapers](https://twitter.com/5hmC_papers) | Papers related to the covalent DNA modification 5-hydroxymethylcytosine, from pubmed and bioRχiv | - |
| [AM Epigenetics Pubs](https://twitter.com/Motif_EpiFeed) | My personal feed for keeping track of epi papers (not a robot, please don't mind my follow) | - |
| [ANH Papers](https://twitter.com/ANH_Papers) | I'm a TwitterBot set up to tweet selected papers from PubMed about artificial nutrition and hydration (ANH). | - |
| [AdapMolEvol papers](https://twitter.com/adapmolevol) | Feed for adaptive molecular evolution papers. | - |
| [Asthma Papers](https://twitter.com/asthma_papers) | RSS feed for #asthma papers in #Pubmed. | - |
| [Autophagy Papers](https://twitter.com/AutophagyPapers) | Twitterbot for #Autophagy papers. Curated by @SoniaHall | - |
| [Autotransporters](https://twitter.com/typevpapers) | Autotransporter (Type V secretion) paper collection from Pubmed and curated by @thesladelab. Find out more at http://thesladelab.com | - |
| [BactSecretionPapers](https://twitter.com/SecretionPapers) | Scientific watch on bacterial secretion systems | - |
| [Behav Ecol Papers](https://twitter.com/BehavEcolPapers) | #BehavioralEcology #Ethology #HumanBehavior #AnimalBehavior #LifeHistory #AnimalPhysiology papers from #PubMed & journal rss-feeds curated by @MihalyFoldvari | - |
| [BioCodePapers](https://twitter.com/BioCodePapers) | Twitterbot of #bioinformatics papers in #PubMed reporting code in @github, @sourceforge, @bitbucket or @google code. Curated by @caseybergman. | - |
| [BioNetPapers](https://twitter.com/bionet_papers) | A feed for papers in network biology. | - |
| [Biofilm Papers](https://twitter.com/biofilmPapers) | Stay on top of all the latest publications on Biofilm research curated from PubMed. #biofilm #microbiology #antibioticresistance. Run by @mccarthy_ronan | - |
| [BioinfoPapers](https://twitter.com/bioinfo_papers) | - | - |
| [Bioinformatics Feeds](https://twitter.com/BioinformaticsP) | New papers from: Oxford Bioinformatics, Briefings in Bioinformatics, BMC Bioinformatics, SCFBM, PLOS CB, ACM/IEEE. Generated with twitterfeed | - |
| [Bioinformatics paper](https://twitter.com/BioinfoPapers) | An up-to-date list of recent bioinformatics publications, for your convenience. | - |
| [Brain Devpt Papers](https://twitter.com/BrainDev_Papers) | twitterbot for #CorticalThickness #SurfaceArea #DTI #Neuroimaging #cognition papers related to #humanBrainDevelopment (curated from #PubMed) by @shaili3 | - |
| [COF_Papers](https://twitter.com/COF_papers) | Bot exposing recent research papers on Covalent-Organic Frameworks (COFs). The project is part of CURATED-COFs: a database of COF structures. by @danieleongari | - |
| [CRISPRpapers](https://twitter.com/CRISPR_Articles) | Follow Me and Keep Up To Date with CRISPR Literature. | - |
| [CRISPRpapers](https://twitter.com/CRISPR_papers) | Automatic Twitterbot for papers on CRISPR/Cas genome engineering. | - |
| [CTCF Papers 📚](https://twitter.com/CTCF_Papers) | PubMed bot reporting all CTCF papers. Maintained by @TeifLab. Also see @TF_binding_bot, @Nucleosome_Bot, @generegulation | - |
| [Cage Papers](https://twitter.com/POC_Papers) | I am a bot digging out papers on molecular/supramolecular cages, organic or coordination. Maintained by @linjiangchen | - |
| [Cancer Papers](https://twitter.com/CancerPapers) | Stay abreast of the latest developments in the fight against cancer with daily publications curated from PubMed. | - |
| [Caulobacter Papers](https://twitter.com/_StalkBot) | I follow Caulobacter. Everywhere it goes. I peer into its incubators late at night. I know its secrets (*vibriodes*). I am in the shadows. Watching. Waiting. | - |
| [Centrosome Papers](https://twitter.com/CentrosomePub) | A friendly bot posting centrosome and centriole papers. Automated alter ego of @StearnsLab. | - |
| [Cichlid Papers](https://twitter.com/cichlid_papers) | Twitterbot of cichlid PubMed papers (inspired by @fly_papers). Image Astatotilapia calliptera, K. Woodhouse. Curated by @domino_joyce. | - |
| [ColSci](https://twitter.com/colsci_papers) | A robot tweeting papers on colouration and vision in nature (#colsci), mostly fed from #pubmed. | - |
| [CompBiolPapers](https://twitter.com/CompBiolPapers) | Feed for sequencing papers | - |
| [CultEvoBot](https://twitter.com/CultEvoBot) | I automatically gather and tweet news/blog posts on cultural evolution. Retired (for the time being...) | - |
| [Cyclic di-GMP Papers](https://twitter.com/cyclicdigmp) | Keep up to date on the latest publications on the universal second messenger Cyclic di-GMP with this twitter feed of up to date publications. | - |
| [DNA topology papers](https://twitter.com/DNAtopologyBot) | Scholar Alerts on DNA topology, made by @biochemistries | - |
| [DNA&RNA Universe ](https://twitter.com/DNA_RNA_Uni) | 𝗧𝗵𝗲 𝘀𝗰𝗶𝗲𝗻𝗰𝗲 𝗼𝗳 𝘁𝗼𝗱𝗮𝘆 𝗶𝘀 𝘁𝗵𝗲 𝘁𝗲𝗰𝗵𝗻𝗼𝗹𝗼𝗴𝘆 𝗼𝗳 𝘁𝗼𝗺𝗼𝗿𝗿𝗼𝘄🧬 #scicomm @NorgenBiotek @INTEGRApipette @plantwave_ | - |
| [DNA-binding drugs📚](https://twitter.com/DNAbinding) | PubMed bot reporting DNA-drug and DNA-ligand binding. Maintained by @TeifLab. Also see @TF_binding_bot, @Nucleosome_Bot, @CTCF_Papers, @generegulation | - |
| [Dendritic cells](https://twitter.com/DCell_papers) | Journal paper feed for academics interested in dendritic cells, immunology and immunity (image source: NIH) | - |
| [EMR Research papers](https://twitter.com/EMR_research) | Real time feed for Electronic Medical Record research papers in #PubMed. Curated by @datajujitsu | - |
| [EcoLog-L](https://twitter.com/EcoLog_L) | Bot that autotweets EcoLog-L posts. Not associated with EcoLog-L. May tweet replies out of order. Maintained by @EcoEvoGames. | - |
| [Edgetics papers](https://twitter.com/edgetics_papers) | New papers using the Vidal lab's interactome 'edgetics' approach (Zhong 2009), made by @biochemistries | - |
| [Engineering Papers](https://twitter.com/eng_papers) | - | - |
| [Enhancer/loops paper](https://twitter.com/loops_enhancers) | #chromatin, #enhancers and #genome_architecture @IvKrivega | - |
| [EvoBehGenPapers](https://twitter.com/EvoBehGe_papers) | Twitterbot of Evolutionary Behavioural Genetics papers in #PubMed. Curated by @darrenjparker | - |
| [EvolDir](https://twitter.com/evoldir) | EvolDir (Evolution Directory) mailing list on topics of interest to evolutionary biologists (conferences, jobs, software, etc.). Twitter version by @rdmpage | - |
| [Fabrice Leclerc](https://twitter.com/rnomics) | #RNomics, #RNA biology, RNA #bioinformatics, #RNA_World & #evolution, technologies & resources, daily papers: http://bit.ly/HaycPM & http://bit.ly/18cyMMK | - |
| [Fruit Worms](https://twitter.com/fruitWormPapers) | Continuous, auto-updated feed of #Celegans (and Caenorhabditeae) wherever they may be found -- PubMed, bioRxiv, and @PeerJ PrePrints. Managed by @microbeMinded. | - |
| [Fusobacterium Papers](https://twitter.com/fusopapers) | Fusobacterium paper collection from Pubmed and curated by @thesladelab. Find out more at http://thesladelab.com | - |
| [GPCR complex](https://twitter.com/GPCRcomplex) | Tweeting new papers about #GPCR complexes (dimers and oligomers) from PubMed | - |
| [GWAS_lit](https://twitter.com/GWAS_lit) | Pre-publication manuscripts for genome-wide association studies. By @wpgilks Also see @genomic_pred and @Mendelian_lit #GWAS #genetics #genomics #medicine | - |
| [Genome in 3-D](https://twitter.com/3D_Genome) | Twitterbot that tweets links to any new papers on Genome in 3D (Hi-C, DNAse-seq, FAIRE-seq, Chip-exo). Maintained by @Alexis_Verger | - |
| [Helminth papers](https://twitter.com/worm_papers) | Automated paper feed twitter bot for academics interested in parasitic worms, gut parasites and anthelminthics | - |
| [Hematopoiesis](https://twitter.com/HSC_papers) | - | - |
| [Hot Spot Prediction](https://twitter.com/hotspot_papers) | Daily RSS Feed for Protein Hot Spot Prediction papers. Maintained by @selinkaragulle | - |
| [Hypoxia Adaptation](https://twitter.com/hypoxiapapers) | A feed for hypoxia related papers published in NCBI, ArXiv, bioArxiv, and PeerJ | - |
| [I Know Science, Me!](https://twitter.com/ArxivBot) | Posting cool research papers from http://arXiv.org every 2h on Physics, Mathematics, Computer Science, Biology, and Statistics. (Bot by @alexjc.) | - |
| [IDP Papers](https://twitter.com/IDP_papers) | Google Scholar Alerts for intrinsically disordered proteins. Code by @biochemistries, set up your own: https://github.com/lmmx/ScholarDaemon | - |
| [Ice-templating papers](https://twitter.com/IT_papers) | Tweetbot about ice-templating or freeze-casting scientific papers. Maintained by @DevilleSy | - |
| [ImmunologyPapers](https://twitter.com/Immunol_papers) | A TwitterBot for #Immunology papers on #PubMed searching for adaptive, innate and cyto/chemokine. Curated by @ulrikstervbo. For setup see http://bit.ly/1rwtvYu | - |
| [James A. Letts](https://twitter.com/LettsScience) | Assistant Professor of Molecular and Cellular Biology, UC Davis. Membrane protein biochemistry, biophysics and structural biology #cryoEM. Bioenergetics. | - |
| [Journal Club Bot](https://twitter.com/JC_pathogenomic) | I'm a Bot. I post interesting papers. Maintained by @happy_khan | - |
| [Keeping up with TEs](https://twitter.com/TE_papers) | I am a twitterbot posting #transposable element papers from #PubMed and #bioRxiv. Curated by @nels42 | - |
| [Literature Bot](https://twitter.com/litscraper) | - | - |
| [Loraine Lab](https://twitter.com/ASplant_papers) | Papers on alternative splicing in plants. | - |
| [MOF Papers](https://twitter.com/MOF_papers) | I'm a bot surveying the metal–organic frameworks (MOF) literature for you! Operated by @fxcoudert, written in open source code | - |
| [MS Papers](https://twitter.com/MltplSclppr) | - | - |
| [Metabolism Preprints](https://twitter.com/preprints_metab) | - | - |
| [Metagenomics Papers](https://twitter.com/metagenomic_lit) | I'm a bot Tweeting newly published papers on metagenomics. Powered by IFTTT. | - |
| [Microbiome Live News](https://twitter.com/metagenomics) | Automated newsfeed dedicated to scientific information on the human microbiome. Share & RT of articles ≠ endorsement. | - |
| [NDMPapers](https://twitter.com/NDM_Papers) | RSS feed from PubMed, that shows the most recent scientific papers from the Nuffield Department of Medicine, University of Oxford. Refreshes daily. | - |
| [NK papers](https://twitter.com/NK_papers) | Paper Twitterbot for academics with an interest in NK cell biology. | - |
| [NRPSpapers](https://twitter.com/NRPS_papers) | Twitterbot of nonribosomal or nrps or non-ribosomal in #Pubmed created and curated by jem.stach@ncl.ac.uk | - |
| [Nature Articles](https://twitter.com/NatureArticles) | Topics, news and more about nature. | - |
| [Nematode_papers](https://twitter.com/Nematode_papers) | Twitter bot searching the web for new journal articles on #nematodes | - |
| [NeuroGenetics papers](https://twitter.com/NeuroGen_papers) | Twitterbot from @TheGBLab! Follow me to stay up to date with research in #Alzheimer's, #Parkinson's & #Neurogenetics in general. Also on http://goo.gl/BNgYFd | - |
| [Neurogenetics Litera](https://twitter.com/NeurogeneticsL) | - | - |
| [New SSNMR Papers](https://twitter.com/solidstateNMR) | Updated by Luke O'Dell, Associate Professor at Deakin University, Australia. Thanks also to Victor Terskikh (@nmr900). | - |
| [Nucleosome papers 📚 NucPosDB database](https://twitter.com/Nucleosome_Bot) | All papers & preprints about nucleosomes. Maintained by @TeifLab. Also see @TF_binding_bot, @CTCF_papers, @cfDNA_papers, @generegulation | - |
| [Parasitology papers](https://twitter.com/par_papers) | Twitterbot of #Parasitology papers in PubMed, bioRxiv, and PeerJ PrePrints. Image from http://goo.gl/BmutPf. Run by @FilipHusnik | - |
| [PeptidoglycanPapers](https://twitter.com/GlcNAcMurNAc) | This account is maintained by Patrick Moynihan (@pmoyniha). If you have any suggestions to improve it please feel free to let me know! | - |
| [Phagepapers](https://twitter.com/phagepapers) | Tweet bot that delivers new phage related papers and news! Tweets are not endorsements! Managed by @jamesrgurney | - |
| [Phages & Crisprs](https://twitter.com/CrisprPhages) | A twitterbot posting the latest pubmed publications on CRISPRs, phages, virusses and prophages. | - |
| [Phase Transition Papers](https://twitter.com/Pha_Tran_Papers) | Just an automated literature surveying bot that helps you keep up with phase transition phenomena of biomolecules pro bono. Creator & guardian: @ChingCyan. | - |
| [PlantEcologyBot](https://twitter.com/PlantEcologyBot) | Automatically tweets ecological content from journals in plant biology. Auto filtering used to select content. Maintained by @EcoEvoGames | - |
| [PolyQReviewPapers](https://twitter.com/polyqr_papers) | Twitter bot posting PubMed entries for reviews on polyglutamine (polyQ), as relevant to Huntington and other CAG repeat expansion diseases. (by @p_vanderwel) | - |
| [Pooled Sequencing](https://twitter.com/pooledseq) | A feed for papers related to pooled-, population-, or evolved and re- sequencing published in NCBI, ArXiv, and bioArxiv. | - |
| [Popgenomics Papers](https://twitter.com/Popgen_Papers) | New Publications in Population Landscape and Ecological Genomics from #arXiv, #bioRxiv and #Pubmed. Curated by Vikram Chhatre (@popgenomics) | - |
...
| [PromisingPreprints](https://twitter.com/PromPreprint) | A bot tweeting @biorxivpreprint publications reaching the top 10% @altmetric score within their first month after publication | - |
| [Pub Snips 🔬](https://twitter.com/PubSnips) | Ridiculously short, human-written summaries of impactful biological publications written by a PhD scientist (art by David Goodsell) | - |
| [QIMRBerghofer papers](https://twitter.com/QIMRBergh_pubs) | Official feed of scientific publications by QIMR Berghofer researchers from PubMed - This is an automated feed. Please direct any tweets at @QIMRBerghofer | - |
| [Quantitative Biology](https://twitter.com/BioPapers) | New Quantitative Biology submissions to http://arxiv.org (not affiliated with http://arxiv.org) | - |
| [RNA Maker](https://twitter.com/RNAMaker) | - | - |
| [RNAi papers](https://twitter.com/RNAi_papers) | Twitter bot searching the web for new journal articles on #RNAi therapeutics for plants and animals | - |
| [RNApreprints](https://twitter.com/RNApreprints) | Combing @biorxivpreprint, @arXiv, and @thePeerJ for RNA content ahead of peer-review publication. #preprints #ASAPbio Manually curated by @VidigalJoana | - |
| [Ribosome Papers](https://twitter.com/ribosome_papers) | New #Ribosome papers from #Pubmed, #bioRxiv, and #arXiv. Also blogged at: http://ribosome-papers.tumblr.com maintained by @slavovLab and @slavov_n | - |
| [Root Papers](https://twitter.com/RootPapers) | Daily RSS feed for #Plant Root papers in #PubMed, #arXiv, #Bioarxiv and #PeerJ Preprints. Curated by @rubenrellan | - |
| [SWI/SNF](https://twitter.com/swisnf) | Built by @joshbiology in @kadochlab using https://github.com/roblanf/phypapers | - |
| [Satellite Cell Bot](https://twitter.com/MuscleStemCell) | Tweeting articles on muscle stem cells from pubmed RSS feeds. | - |
| [Shawn's archaeobot](https://twitter.com/botarchaeo) | A bot tweeting links to new archaeological journal articles. Limited to those journals that provide RSS! | - |
| [Single Cell papers](https://twitter.com/scell_papers) | A twitter bot account for papers employing sequencing of single cells | - |
| [Small RNA papers](https://twitter.com/sRNAPapers) | A Twitter bot to keep up with papers and preprints related to #smallRNAs. Biased towards plants. Using http://dlvr.it. Curated by @psaima. | - |
| [Sponge Papers](https://twitter.com/sponge_papers) | Recent papers on sponges (Phylum Porifera). | - |
| [Strep_papers](https://twitter.com/Strep_papers) | Twitterbot of #Streptomyces papers in #Pubmed created and curated by @paulhoskisson | - |
| [Super Res Microscopy](https://twitter.com/SRMicro_papers) | Twitterbot for anything related to super resolution microscopy | - |
| [Symbiosis papers](https://twitter.com/Symbiosispapers) | RSS feed of new symbiosis- and microbiome-related papers in PubMed. Managed by @KlassenLab. Image from wikimedia, public domain. | - |
| [Synthetic Lethality](https://twitter.com/cancerSL) | Daily RSS feed for papers on Synthetic Lethality in Cancer. cancer AND (synthetic lethal OR synthetic lethality). Largely automated, don't expect responses | - |
| [T3SS](https://twitter.com/T3SS2) | Manually curated posts on type III secretion system. | - |
| [TC_papers](https://twitter.com/TC_papers) | Pubmed twitterbot: arealization OR patterning OR somatosensory OR thalamus OR thalamocortical OR cortical development | - |
| [TF binding papers 📚 NucPosDB database](https://twitter.com/TF_binding_bot) | Papers on transcription factor binding #TFbinding. Maintained by @TeifLab. Also see @nucleosome_bot, @CTCF_papers, @DNAbinding, @cfDNA_papers, @generegulation | - |
| [Transcriptomes](https://twitter.com/transcriptomes) | Transcriptome feed using #Rstats by @davetang31. Updates made each day 16:00 EST. Image from http://goo.gl/O | - |
| [Transcrp'n noise bot](https://twitter.com/TransxnNoiseBot) | Scholar alerts on transcriptional noise, made by @biochemistries | - |
| [TumorImmunoPapers](https://twitter.com/TumorImm_papers) | A TwitterBot for Cancer Immunology and Tolerance papers on #PubMed. Curated by @adamsnookphd http://adamsnook.science | - |
| [University of Warwick Research Archive Portal](https://twitter.com/wrap_papers) | University of Warwick Publications Service and WRAP. Simple Deposit: http://warwick.ac.uk/irsubmit. Support via email: publications{AT}http://warwick.ac.uk | - |
| [VEGF RSS Feeds](https://twitter.com/VEGFRSSfeeds) | - | - |
| [VijiDraviam](https://twitter.com/mitosis_papers) | - | - |
| [Vitamin A papers](https://twitter.com/vitamin_A_paper) | Twitter feed of #vitaminA papers published in #PubMed, + related content ranging from basic science to global health. #retinoids too! Curated by @robin_clugston | - |
| [Wnt publications](https://twitter.com/WntPublications) | Twitterbot on Wnt signaling pathway publications #Wnt #PubMed | - |
| [Zeolite_papers](https://twitter.com/Zeolite_papers) | This is a bot feeding you recently uploaded preprints and published papers on zeolites. Maintained by @slaterben1. | - |
| [aDNA_papers](https://twitter.com/aDNA_papers) | TwitterBot for papers in ancient DNA and human genomics from arXiv, bioRxiv, & Pubmed. Curated by @bigskybioarch | - |
| [arXiv gr-qc](https://twitter.com/arXiv_grqc) | A new way to get your daily dose of gr-qc preprints from arXiv | - |
| [bioRxiv Bioinfo](https://twitter.com/biorxiv_bioinfo) | - | - |
| [bioRxiv Biophysics](https://twitter.com/biorxiv_biophys) | - | - |
| [bioRxiv Cell Biology](https://twitter.com/biorxiv_cellbio) | - | - |
| [bioRxiv Ecology](https://twitter.com/biorxiv_ecology) | - | - |
| [bioRxiv Evobio](https://twitter.com/biorxiv_evobio) | - | - |
| [bioRxiv Genetics](https://twitter.com/biorxiv_genetic) | - | - |
| [bioRxiv Genomics](https://twitter.com/biorxiv_genomic) | - | - |
| [bioRxiv Microbiology](https://twitter.com/biorxiv_micrbio) | - | - |
| [bioRxiv Neuroscience](https://twitter.com/biorxiv_neursci) | - | - |
| [bioRxiv Plant Bio](https://twitter.com/biorxiv_plants) | - | - |
| [bioRxiv Published](https://twitter.com/biorxiv_pubd) | The non-profit preprint server for the life sciences | - |
| [bioRxiv SysBio](https://twitter.com/biorxiv_sysbio) | - | - |
| [bxv_biochem](https://twitter.com/bxv_biochem) | Alert for pre-print manuscripts about Biochemistry, sources biorxiv #openaccess #biochemistry #biochem by @wpgilks | - |
| [bxv_cell](https://twitter.com/bxv_cell) | Alert for pre-print manuscripts in Cell biology, sources bioarxiv #openaccess #cell #cellbiol by @wpgilks | - |
| [bxv_microbiol](https://twitter.com/bxv_microbiol) | Alert for pre-print manuscripts on Microbiology, sources biorxiv #openaccess #science #microbiology #bacteria #microbiol by @wpgilks | - |
| [bxv_molbiol](https://twitter.com/bxv_molbiol) | Molecular biology pre-prints from bioarxiv #openaccess #science #molbiol #molecularbiology | - |
| [chemotaxis papers](https://twitter.com/chemotaxisrss) | Curated feed for bacterial chemotaxis papers. #chemotaxis #bacterialchemotaxis #flagella | - |
| [cohesin_papers](https://twitter.com/cohesin_papers) | Pubmed RSS paper feed on cohesin and its 'friends': condensin, Smc5/6, Scc2 (NIPBL), Scc4 (Mau2) and MukBEF. | - |
| [cryoEM Papers](https://twitter.com/cryoEM_Papers) | I'm a bot that surveys the cryoEM literature for you! Operated by @fredericpoitev1 & @CorneliusGati, adapted from PaperBots twitter app developed by @fxcoudert CO2_papers @CO2_papers Tweets academic papers on anything/everything about carbon dioxide. Maintained by @DrYGChung Electrocatalysis Papers @ECat_papers I'm a bot that surveys the Electrocatalysis literature for you! Operated by @yerga and based on @MOF_papers | - |
| [eQTLpapers](https://twitter.com/eQTL_papers) | TwitterBot for eQTL papers from PubMed, arXiv, bioRxiv, and PeerJ PrePrints. Maintained by @sarahfbrooks | - |
| [epigenetics_papers](https://twitter.com/epigen_papers) | Chromatin & epigenetics paper feed from #Pubmed and #Arxiv - hear it here first! Comments & suggestions welcome. Also http://epigen-papers.tumblr.com By @mariamdemidova | - |
| [flypapers](https://twitter.com/fly_papers) | Twitterbot of #Drosophila papers in #PubMed/#arXiv/#bioRxiv/#PeerJ/#F1000. Curated by @caseybergman. Image credit: http://en.wikipedia.org/wiki/Drosophila_hydei | - |
| [glycopreprint](https://twitter.com/glycopreprint) | Glycosylation preprints from bioRxiv and chemRxiv. The scraped DOI links from new articles can take a bit of time to be activated. | - |
| [gyrpapers](https://twitter.com/gyr_papers) | Literature bot searching arXiv, biorXiv, PeerJ & PubMed for supercoiling papers. Maintained by @red_gravel. | - |
| [lncRNApapers](https://twitter.com/lncRNA_papers) | Bringing you the latest in #lncRNA scientific literature. Mention for retweet. #lincRNA #lncRNA #longnoncodingRNA #RNA #biochem #pubmed #science | - |
| [meiosispapers](https://twitter.com/meiosis_papers) | Recent meiosis papers from pubmed RSS and bioRχiv. Maintained by @pmcarlton | - |
| [memprotbiophys](https://twitter.com/memprot_biophys) | - | - |
| [microRNApapers](https://twitter.com/microRNA_papers) | Twitterbot for microRNA papers from PubMed, arXiv, bioRxiv, and PeerJ. Papers should trickle in (2-3/hr), not flood. | - |
| [phylogeopapers](https://twitter.com/phylogeo_papers) | RSS feed from arXiv, bioRxiv, Pubmed, and PeerJ maintained by @michaelgharvey | - |
| [phypapers](https://twitter.com/phy_papers) | Continuous feed for phylogenetics papers from PubMed, arXiv, bioRxiv, and PeerJ PrePrints. Run by @RobLanfear | - |
| [plant_biology_nsp](https://twitter.com/PlantBiologyNSP) | A twitter bot that automatically tweets new articles related to plant biology in Nature, Science and PNAS using zapier and dlvrit. | - |
| [pseudomonaspapers](https://twitter.com/pseudo_papers) | PubMed search bot for pseudomonas. Opinions are my own and indicate terrifying emergence of sentience. Alert @kay_aych in case of robot uprising/bugs. | - |
| [regulonPapers](https://twitter.com/regulon_papers) | Twitterbot of papers related to gene regulation and regulatory elements in Drosophila #PubMed/#bioRxiv . imageSource: google images. created by @pra514 | - |
| [scientificpapers](https://twitter.com/scientificpaper) | - | - |
| [single cell papers](https://twitter.com/sc_papers) | - | - |
| [synbiopapers](https://twitter.com/synbio_papers) | TwitterBot collecting #synbio papers | - |
| [topbiopapers](https://twitter.com/topbiopapers) | Streaming biological articles of top relevance in the fields of cell- and molecular biology and genetics. Caution: addictive! | - |
| [ufkl bot](https://twitter.com/UfklBot) | - | - |
...
| [JustDiedBot](https://twitter.com/JustDiedBot) | Bot that scrapes Wikipedia and immediately tweets RIP messages when there is a celebrity death. Member of The Bot Collective, a project by @kildall | - |
